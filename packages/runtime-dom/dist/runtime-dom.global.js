...
Component that was made reactive: `,
  ...
  function createVnode(type, props, children = null) {
    let shapeFlag = isString2(type) ? 1 /* ELEMENT */ : 0;
    const vnode = {
      // vnode也就是虚拟节点
      type,
      props,
  ...
  function h2(type, propsChildren, children) {
    const l = arguments.length;
    if (l == 2) {
      if (isObject2(propsChildren) && !isArray2(propsChildren)) {
